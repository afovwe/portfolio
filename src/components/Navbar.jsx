    ...
    const Navbar = () => {
        ...
        return (<div className='px-4 sm:px-6 lg:px-8 mx-auto max-w-[1500px] h-[8vh]'>
            <div className='flex item-center justify-between h-16 lg:h-20 bg-[#223]/30 rounded-b-3xl shadow-lg px-4'>
            
            <div className="text-white text-xl sm:text-2xl">
                <a href="/home" className="font-bold"><span>Omofovwe Akpadaka</span></a>
        ...
        <NavLink to="/contact" activeClassName="text-black">Contact</NavLink>
           ...
           <div onClick={handleNav} className='block md:hidden text-white z-40' >
            ...
            <div className={nav ? 'z-30 text-gray-300 fixed h-[50%] left-0 top-0 w-full bg-[#202121] ease-in-out duration-500'
             : 'fixed left-[-100%]'} >
                <h1 className='text-3xl gray-primary-color m-4' > Omofovwe Akpadaka </h1>
